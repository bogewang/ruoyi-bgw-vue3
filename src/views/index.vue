<template>
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8"><el-card class="update-log" @click="handleTodaySale"> 今日销售额1000</el-card></el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="8"><el-card class="update-log" @click="handleTodaySale"> 今日销销售毛利200</el-card></el-col>
      <el-col :xs="24" :sm="24" :md="12" :lg="8"><el-card class="update-log" @click="handleTodaySale"> 今日销销售笔数</el-card></el-col>
    </el-row>
